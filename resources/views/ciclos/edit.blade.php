...
<h3 class="text-left titulo pt-5 ">EDITAR DATOS DE CICLO FORMATIVO</h3>
    <!-- Formulario para coger los datos de la empresa-->
    <form class=" mt-5 mb-5 needs-validation" novalidate  action="{{action('CiclosController@postUpdate',$ciclo->id_ciclos_formativos)}}" method="POST">
      {{method_field('POST')}}
      {{ csrf_field() }}
      <div class="form-row">
