...
<div class="text-left titulo  pt-5 ">OFERTAS</div>
...
<div class="container">
    ...
    @foreach($ofertas as $oferta)
        <div class="item card-group col-xs-4 col-lg-4 ">
            <div class="thumbnail card mb-5 ">
                
                <div class="caption card-body">
                <h4 class="font-weight-bold group card-title  inner list-group-item-heading">{{$oferta->puesto}}</h4>
